...
import SavedPizzaArea from "containers/PersonalArea/SavedPizzaArea/SavedPizzaArea";
import Layout from "../layout";
import { reduxWrapper } from "redux/store";
import ISR from "utils/ISR";
import Api from "api/requests";

export default function SavedPizzasPage() {
	return (
		<>
			<SavedPizzaArea />
		</>
...
SavedPizzasPage.getLayout = function getLayout(page) {
