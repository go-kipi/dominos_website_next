import PersonalAreaAdressessDesktop from "containers/PersonalArea/PersonalAreaAdressessDesktop/PersonalAreaAdressessDesktop";
...
export default function SavedAddressesPage() {
	return (
		<>
			<PersonalAreaAdressessDesktop />
		</>
	);
}
SavedAddressesPage.getLayout = function getLayout(page) {
